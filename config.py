...
class ConfigKey(str, Enum):
    ...
    STRESS_TEST_WRITES = "STRESS_TEST_WRITES"
    ...
    METRIC_BASE_DIR = "METRIC_BASE_DIR"
    METRIC_BACKUP_DIR = "METRIC_BACKUP_DIR"
    METRIC_MAIN_FILE_NAME = "METRIC_MAIN_FILE_NAME"
    METRIC_BACKUP_COUNT = "METRIC_BACKUP_COUNT"
    METRIC_LOGGER_NAME = "METRIC_LOGGER_NAME"
    METRIC_FILE_SIZE = "METRIC_FILE_SIZE"
    METRIC_QUEUE_MAX_SIZE = "METRIC_QUEUE_MAX_SIZE"
...
DEFAULT_CONFIG = {
    ...
    "METRIC_BASE_DIR": "counters",
    "METRIC_BACKUP_DIR": "history",
    "METRIC_MAIN_FILE_NAME": "counters",
    "METRIC_BACKUP_COUNT": 5,
    "METRIC_LOGGER_NAME": "MAIN",
    "METRIC_FILE_SIZE": 1024,
    "METRIC_QUEUE_MAX_SIZE": 100000,
    "METRIC_QUEUE_STRATEGY": "LOSSLESS",
